...
bool
operator!=(double volume, const Box& box)
{
        return volume != box.getVolume();
}

/* Must return true if Box's volume is zero. */
/* bool */
/* Box::operator!() const */
/* { */
...
{
        /* This was my solution at first, but I liked the solution
         * I saw at the Apress repository *after* have done it. */
        /* return getVolume() == 0.0 ? false : true; */
        return getVolume() != 0.0;
}
