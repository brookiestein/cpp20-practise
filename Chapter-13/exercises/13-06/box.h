...
class Box
{
        public:
                ...
                /* Add support for comparing such as if (myBox), etc. */
                /* bool operator!() const; */
                /* Using the type conversion technique to allow statements such as if (myBox)
                 * Evaluates to true if Box's volume is > 0.0. */
